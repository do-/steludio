...
begin
	...
	+ #13 + #9 + #9 + #9 + #9 + #9 + '{icon => ''edit'', label => ''Редактировать'', href => "/?type=' + GetTypeName + '&id=$$i{id}"},'
	+ #13 + #9 + #9 + #9 + #9 + #9 + '{icon => ''delete'', label => ''Удалить'', href => "/?type=' + GetTypeName + '&action=delete&id=$$i{id}", confirm => "Удалить $$i{label}?"},'
	...
	+ #13 + #9 + #9 + #9 + #9 + #9 + #9 + 'label   => ''слить выделенные'','
	+ #13 + #9 + #9 + #9 + #9 + #9 + #9 + 'href    => ''javaScript:document.form.submit()'','
	+ #13 + #9 + #9 + #9 + #9 + #9 + #9 + 'confirm => ''Вы уверены, что?..'','
	+ #13 + #9 + #9 + #9 + #9 + #9 + '},'
	+ #13 + #9 + #9 + #9 + #9 + ']),'
	+ #13 + #9 + #9 + #9 + '}'
	+ #13 + #9 + #9 + ');'
	...
	+ #13 + #9 + #9 +'{'
	+ #13 + #9 + #9 +#9 +''
	+ #13 + #9 + #9 +#9 +'title => {label => ''Похожие названия''},'
	+ #13 + #9 + #9 +#9 +''
	...
	+ #13 + #9 + #9 +#9 +#9 +#9 +'label => ''По скольким буквам'','
	+ #13 + #9 + #9 +#9 +#9 +#9 +'size  => 2,'
	...
	+ #13 + #9 + #9 +#9 +#9 +#9 +#9 +'label   => ''слить выделенные записи с текущей'','
	+ #13 + #9 + #9 +#9 +#9 +#9 +#9 +'href    => "javaScript:if(confirm(''Вы уверены, что все выделенные записи совпадают по смыслу с текущей?''))document.forms[''t1''].submit()",'
	+ #13 + #9 + #9 +#9 +#9 +#9 +'}'
	+ #13 + #9 + #9 +#9 +#9 +']'
	+ #13
	+ #13 + #9 +#9 +#9 +'),'
	...
	+ #13 + '#'#9 + '$_REQUEST {_label} or return "#_label#:Вы забыли ввести наименование";'
        + #13
	+ #13 + #9 + 'return undef;'
        ;
